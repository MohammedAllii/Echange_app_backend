...
@section('content')
    <div class="container">
        <img src="{{ asset('bloced.png') }}" alt="Your Image Description" height="100">

        <div class="d-flex justify-content-between align-items-center">
            <h2 class="text-center">All Users (Banned)</h2>

            <!-- Switcher to Redirect to "/notban" route -->
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="notBanSwitch">
                <label class="form-check-label" for="notBanSwitch">Show users not Banned</label>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr style="background-color: red">
                            <td class="text-center"  style="background-color: rgb(246, 132, 100)">{{ $user->id }}</td>
                            <td class="text-center"  style="background-color: rgb(246, 132, 100)">{{ $user->name }}</td>
                            <td class="text-center"  style="background-color: rgb(246, 132, 100)">{{ $user->email }}</td>
                            <td  style="background-color: rgb(246, 132, 100)">
                                ...
                                <a href="#" class="btn btn-sm" title="Ban" data-bs-toggle="modal" data-bs-target="#banModal{{ $user->id }}">
                                    <img src="{{ asset('unlock.png') }}" alt="Category Image" style="max-height: 30;max-width: 60;">
                                </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-sm btn-success" title="Ban" onclick="banUser('{{ $user->id }}')">
                                                    <img src="{{ asset('unlock.png') }}" alt="Ban User" style="max-height: 30; max-width: 60;">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
